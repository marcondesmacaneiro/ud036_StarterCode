...
captain_marvel = media.Movie("Captain Marvel",
                             "Is an upcoming American superhero film based on the Marvel Comics.",
...
venom = media.Movie("Venom",
                    ...
                    "http://t2.gstatic.com/images?q=tbn:ANd9GcRvT1RlWWfdCEOyeF00_yBwYzSg4_Nm9oWPNfRMJGviWb6hnLLW",
